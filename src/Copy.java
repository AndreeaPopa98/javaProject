	...
	public List<Object[]> getAllSongs(SongDAO sDAO) {
		...
		for (int i = 0; i < songs.size(); i++) {
			list.add(new Object[] {
					...
					songs.get(i).getDuration(), "Play", "Delete", "Add to Playlist"
...
//	<--------------------------------------------->
	public List<Object[]> getAllSongsInPlaylist() {
		...
		for (int i = 0; i < songs.size(); i++) {
			list.add(new Object[] {
					songs.get(i).getId(),songs.get(i).getTitle(),"Repeat"
			});
...
//		<--------------------------------------------->
		...
		dm.setDataVector(list.toArray(new Object[][] {}),
				new String[] { "ID", "Artist", "Title", "Type", "Duration", "Play", "Delete", "Add to Playlist" });

		JTable table = new JTable(dm);
		JScrollPane scroll = new JScrollPane(table);
		scroll.setBounds(0, 11, 547, 133);
...
//	<--------------------------------------------->		
		Action addToPlaylist = new AbstractAction() {
			public void actionPerformed(ActionEvent e) {
				...
				scroll1.setBounds(330, 184, 192, 123);
...
//	<--------------------------------------------->		
		Action delete = new AbstractAction() {
			public void actionPerformed(ActionEvent e) {
				...
				dm2.setDataVector(lista.toArray(new Object[][] {}), new String[] { "ID", "Artist", "Title", "Type",
						"Duration", "Delete", "Play", "Add to Playlist" });
				table.setModel(dm2);
...
//	<--------------------------------------------->	
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				sg.setType(textDuration.getText());
				...
				List<Object[]> list = getAllSongs(sDAO);
				DefaultTableModel dm1 = new DefaultTableModel();
				dm1.setDataVector(list.toArray(new Object[][] {}), new String[] { "ID", "Artist", "Title", "Type",
						"Duration", "Play", "Delete", "Add to Playlist" });
				table.setModel(dm1);
		...
		btnSeeSongs.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (SongPlayed s : pDAO.songsPlayed())
				{
					...
					System.out.println(sg);
					dlm.addElement(sg.getArtist() + " - " + sg.getTitle() + " : " + s.getNrRepetari());
				}

				JList jlist= new JList(dlm);
				jlist.setLocation(200,200);
				jlist.setSize(29, -27);
				
				jlist.setBounds(300, 350, 115, 87);
...
//	<--------------------------------------------->
		JButton btnSeeSongsToday = new JButton("See today");
...
//  Butonul See Top Songs WEEK cu actiunea lui
//	<--------------------------------------------->
		JButton btnSeeSongsWeek = new JButton("See week");
		btnSeeSongsWeek.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				for (SongPlayed s : pDAO.songsPlayedToday())
					System.out.println(s);
			}
		});
		btnSeeSongsWeek.setBounds(200, 250, 120, 23);
		contentPane.add(btnSeeSongsWeek);
//	<--------------------------------------------->
...
//	<--------------------------------------------->
		...
		btnPlayPlaylist.setBounds(320, 155, 115, 23);
